...
{
    /// <summary>
    /// Класс основных констант меню редактирования настроек (язык: Русский)
    /// </summary>
    internal static class ChangeSettingsMenuConstantsRU
    {
        ...
        public const string ChangeSettingsSuccessMessage = "Настройки успешно изменены, нажмите Enter чтобы продолжить";
    }
}
