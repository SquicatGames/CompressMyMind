namespace CMM.Core.BL.Core.Common.Localization.RU
{
    ...
    /// </summary>
    internal static class MainMenuOptionDescriptionsRU
    {
        public const string MainMenuCompressionOptionTitle = "Сжатие текстовых данных. \nУкажите расположение и имя файла и нажмите Enter чтобы продолжить. Или введите 0, чтобы вернуться в главное меню";
        public const string MainMenuDecompressionOptionTitle = "Распаковка текстовых данных. \nУкажите расположение и имя архива и нажмите Enter чтобы продолжить. Или введите 0, чтобы вернуться в главное меню";
