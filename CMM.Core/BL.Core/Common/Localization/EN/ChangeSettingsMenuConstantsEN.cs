...
{
    /// <summary>
    /// Класс основных констант меню редактирования настроек (язык: Английский)
    /// </summary>
    internal static class ChangeSettingsMenuConstantsEN
    {
        ...
        public const string ChangeSettingsSuccessMessage = "Settings are successfully saved. Press Enter to continue";
    }
}
